...
class Rent_detail(models.Model):
    ...
    image1=models.ImageField(upload_to='rent',null=True,blank=True)
    image2=models.ImageField(upload_to='rent',null=True,blank=True)
...
class RentComplaint(models.Model):
    user=models.ForeignKey(Account,on_delete=models.CASCADE)
    rent=models.ForeignKey(Rent_detail,on_delete=models.CASCADE)
